// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SystemActor.cs" company="MLambda">
...
namespace MLambda.Actors.Guardian
{
    ...
    public class SystemActor : Actor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemActor"/> class.
        /// </summary>
        /// <param name="bucket">the bucket.</param>
        public SystemActor(IBucket bucket)
        {
            this.bucket = bucket;
        }
        ...
        private IObservable<Unit> Kill(Kill message) => this.bucket.Release(message.Id);
    }
}